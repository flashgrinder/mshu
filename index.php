			...
			<div class="reg-slider__item swiper-slide">
				<div class="reg-slider__outer">
					<div class="reg-slider__inner">
						<h2 class="reg-slider__title title title--medium title--white title--w-bold">IV Саратовский молодежный юридический форум «Роль права
							в обеспечении национальной безопасности современной России»</h2>
						<div class="reg-slider__description text text--medium text--white text--w-regular">Сессия «Открытие II сезона комплексного просветительского проекта «Молодежная школа юриста»</div>
						<div class="reg-slider__layout">
							<ul class="reg-slider__info-list text text--medium text--white text--w-regular">
								...
								<li class="reg-slider__info-item">
									...
									СГЮА, ул. Чернышевского, 104, корпус 1, аудитория 102.
								</li>
							</ul>
							<a href="javascript:;" class="reg-slider__button button button--primary js-reveal gs-reveal a-reveal-right" data-modal="#registration">
								Принять участие
							</a>
						</div>
					</div>
