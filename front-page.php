			...
			<div class="video-slider__items swiper-wrapper">
				...
				?>
						<div class="video-slider__item swiper-slide">
							<iframe class="video-slider__player" width="100%" height="100%" src="<?php echo esc_url($video_link); ?>" frameBorder="0" allow="clipboard-write; autoplay" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
						</div>
				<?php endif;
				endwhile; ?>
			</div>
