...
(function (global, factory) {
  ...
  class Store {
    ...
    addOption(option) {
      let addToStart = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      if (addToStart) {
...
function init() {
  ...
  const citySelectModal = new _hystmodal.default({
...
},{"hystmodal":2}],9:[function(require,module,exports){
"use strict";
...
},{"hystmodal":2}],10:[function(require,module,exports){
"use strict";
...
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function init() {
  const participantSelect = new _slimSelect.default({
  ...
  const mentorSelect = new _slimSelect.default({
...
},{"slim-select":3}],15:[function(require,module,exports){
"use strict";
...
var _gsap = _interopRequireDefault(require("gsap"));
var _gsReveal = _interopRequireDefault(require("../libs/modules/gs-reveal"));
var _modal = _interopRequireDefault(require("../libs/modules/modal"));
var _scrollHeader = _interopRequireDefault(require("../libs/modules/scroll-header"));
var _burgerMenu = _interopRequireDefault(require("../libs/modules/burger-menu"));
var _quotes = _interopRequireDefault(require("../libs/modules/quotes"));
var _video = _interopRequireDefault(require("../libs/modules/video"));
...
var _mentors = _interopRequireDefault(require("../libs/modules/mentors"));
var _registration = _interopRequireDefault(require("../libs/modules/registration.js"));
var _cookie = _interopRequireDefault(require("../libs/modules/cookie.js"));
var _map = _interopRequireDefault(require("../libs/modules/map.js"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  _scrollHeader.default.init();
  _quotes.default.init();
  _gsReveal.default.init();
  modalTrue ? _modal.default.init() : false;
  modalTrue ? _slimSelect.default.init() : false;
  partnersSliderTrue ? _partners.default.init() : false;
  mentorsSliderTrue ? _mentors.default.init() : false;
  videoSliderTrue ? _video.default.init() : false;
  registrationSliderTrue ? _registration.default.init() : false;
  _cookie.default.init();
  mapBlock ? _map.default.init() : false;
});
